...
export default function Sidebar({ activeSection, onNavigate, currentTrack }: SidebarProps) {
  ...
  const handleClearCache = async () => {
    ...
    if (!confirm("¿Limpiar caché de la aplicación? Esto recargará la página.")) {
      return;
    }
    ...
    try {
      ...
      if ('caches' in window) {
        ...
        console.log('✅ Caches eliminados:', cacheNames.length);
      }
      ...
      // Recargar la página de forma forzada (bypass cache)
